...
public class AccountManager {
    ...
    public static String[] getBackedUpAccounts(boolean isOwnAccounts) {
        ...
        // Nur Ordner mit .zip Datei oder alte .dat Datei anzeigen (für Rückwärtskompatibilität)
    ...
    private static void setProperPermissions() {
        String[] commands = {
            ...
            "chmod 660 \"" + DATA_DIR + "shared_prefs/*.xml\"",
            "chown $(stat -c %u:%g " + DATA_DIR + ") \"" + DATA_DIR + "shared_prefs/*.xml\""
        };
